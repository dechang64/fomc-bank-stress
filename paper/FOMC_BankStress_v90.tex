...
Using the cross-sectional coefficients from the quasi-experiment (Table~\ref{tab:htm_afs}) and the NIM microfoundation (Table~\ref{tab:nim_microfoundation}), we compute predicted CAR for each bank under two scenarios, then aggregate using asset weights:
