...
Table~\ref{tab:ffiec} confirms that extending the cross-section from N=14 to N=20 US BHCs preserves the qualitative findings for both H3 (CRE exposure) and H5 (capital building), ruling out the concern that the Y-9C sample is a non-random subset.
...
Figure~\ref{fig:cre} visualizes the CRE sensitivity channel: during ZLB periods, high-CRE banks benefit more from dovish FOMC signals, as low interest rates increase the present value of CRE loan cash flows.
...
Figure~\ref{fig:htm_afs} illustrates the divergence between HTM and AFS securities portfolios over time. During the 2022--2023 rapid rate hike period, HTM portfolios accumulate unrealized losses that remain invisible under current accounting rules, while AFS losses are marked to market through AOCI.
